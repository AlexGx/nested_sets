# Contributing to NestedSets

Thank you for your interest in contributing to NestedSets! This guide will help you get started with development and explain our contribution process.
...
- SQLite 3 and/or MySQL (for multi-database testing)
- Git
...
1. **Fork and clone the repository**
   ```bash
   git clone https://github.com/AlexGx/nested_sets.git
   cd nested_sets
   ```
...
4. **Run the tests**
   ...
   # Run only PostgreSQL and MySQL specific tests
...
1. **Test multi-database**: Verify changes work with both PostgreSQL, MySQL and SQLite adapters
...
```bash
# Test against PostgreSQL and MySQL
mix test --exclude sqlite
...
NestedSets follows [Semantic Versioning](https://semver.org/):
...
By contributing to NestedSets, you agree that your contributions will be licensed under the same license as the project (MIT License).

---

Thank you for contributing to NestedSets! Your help makes this project better for everyone.